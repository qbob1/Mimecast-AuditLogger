...
# first file logger
audit_logs = setup_logger('audit_logs', '/var/log/mimecast_audit_logs.log')
# second file logger
error_log = setup_logger('logging_log', '/var/log/mimecast_audit_log_errors.log', logging.ERROR)
